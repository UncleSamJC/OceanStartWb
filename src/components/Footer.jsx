          ...
          <div className="flex flex-wrap justify-start gap-20">
            ...
            <div className="w-full md:w-1/3 space-y-6">
              ...
              <div className="space-y-2 text-gray-400">
                ...
                <p>
                  <a
                    href="mailto:info@ocean-star.ca"
                    className="hover:text-white"
                  >
                    General: info@ocean-star.ca
                  </a>
                </p>
                <p>
                  <a
                    href="mailto:kaelyn@ocean-star.ca"
                    className="hover:text-white"
                  >
                    Marketing: kaelyn@ocean-star.ca
                  </a>
                </p>
                <p>27-6631 Island Highway North, Nanimo, BC. V9T 4T7</p>
              </div>
              <div className="flex space-x-4">
                ...
                <SocialIcon href="https://youtube.com">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.701V8.115l6.06 3.045-6.06 4.725z"
                      clipRule="evenodd"
                    />
                  </svg>
                </SocialIcon>
